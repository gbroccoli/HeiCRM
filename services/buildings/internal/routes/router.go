...
import (
	...
	"github.com/gbroccoli/HeiCRM/services/buildings/internal/handler"
	"github.com/gbroccoli/HeiCRM/services/buildings/internal/middleware"
...
func Mount(r *gin.Engine, h *handler.Handler, j *jwt.JWT) {
	...
	buildings.Use(middleware.AuthMiddleware(j))
	{
		...
		buildings.DELETE("/:id/rooms/:roomId/residents/:userId", middleware.RoleMiddleware(middleware.RoleAdmin), h.RemoveResident)
	}
}

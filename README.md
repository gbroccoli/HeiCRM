...
2. **User Service** (✅ Реализован) — управление профилями пользователей
3. **Building Service** (✅ Реализован) — управление зданиями и комнатами
4. **Task Service** (✅ Реализован) — система заявок
5. **Notification Service** (✅ Реализован) — уведомления (Email, Push, In-app)

📖 **Детальное описание архитектуры:** [SERVICES.md](SERVICES.md)

## Текущее состояние

Все 5 микросервисов реализованы:

- ✅ Auth Service — регистрация, JWT авторизация, refresh tokens, bcrypt
- ✅ User Service — управление профилями пользователей
- ✅ Building Service — управление зданиями, комнатами, этажами
- ✅ Task Service — система заявок с отслеживанием статусов
- ✅ Notification Service — уведомления (email, push, in-app)

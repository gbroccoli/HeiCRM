...
VALUES (0, 'user', 'Обычный пользователь'),
       (1, 'admin', 'Администратор (полный доступ)'),
       (2, 'manager', 'Менеджер (чтение пользователей, управление задачами)') ON CONFLICT (id) DO NOTHING;

-- ============================================================
-- Users (15 пользователей: 1 admin, 2 manager, 12 user)
-- Пароль для всех: Admin123!@#
-- ============================================================
INSERT INTO users (name, email, password, avatar, role_id, tg_send)
VALUES ('Admin', 'admin@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 1, false),
       ('Петров Алексей', 'petrov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 2,
        false),
       ('Сидорова Мария', 'sidorova@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 2,
        false),
       ('Иванов Дмитрий', 'ivanov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Козлова Анна', 'kozlova@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Новиков Сергей', 'novikov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Морозова Елена', 'morozova@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Волков Артём', 'volkov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Лебедева Ольга', 'lebedeva@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Соколов Максим', 'sokolov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Попова Наталья', 'popova@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
        false),
       ('Кузнецов Андрей', 'kuznetsov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL,
        0, false),
       ('Фёдорова Татьяна', 'fedorova@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL,
        0, false),
       ('Михайлов Владимир', 'mikhailov@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2',
        NULL, 0, false),
       ('Егорова Ирина', 'egorova@heicrm.ru', '$2a$10$UmBhHPqAIfchKGrg/uQMcOTFsJP4uiFLGsjcUMk64geFB3/Pqupz2', NULL, 0,
...
-- ============================================================
INSERT INTO user_profiles (user_id, first_name, last_name, middle_name, phone, student_id, room_id, avatar_url,
                           date_of_birth)
VALUES (1, 'Администратор', 'Системный', NULL, '+79001000001', NULL, NULL, NULL, '1990-01-01'),
       ...
       (15, 'Ирина', 'Егорова', 'Сергеевна', '+79001000015', 'STU-012', NULL, NULL,
        '2001-03-25') ON CONFLICT (user_id) DO NOTHING;

-- ============================================================
-- Buildings (3 здания)
-- ============================================================
INSERT INTO buildings (id, address, floors, description)
VALUES (1, 'ул. Ленина, 10', 5, 'Общежитие №1 — основной корпус'),
       (2, 'ул. Пушкина, 25', 4, 'Общежитие №2 — новый корпус'),
       (3, 'пр. Мира, 8', 3, 'Общежитие №3 — малый корпус') ON CONFLICT (id) DO NOTHING;
...
-- ============================================================
INSERT INTO rooms (id, building_id, room_number, floor, capacity, room_type, status)
VALUES (1, 1, '101', 1, 1, 'single', 'occupied'),
       ...
       (15, 3, '301', 3, 2, 'double', 'free') ON CONFLICT (building_id, room_number) DO NOTHING;
...
-- ============================================================
INSERT INTO residents (id, room_id, full_name, birth_date, email, phone, move_in_date, move_out_date)
VALUES (1, 1, 'Иванов Дмитрий Сергеевич', '2003-05-10', 'ivanov@heicrm.ru', '+79001000004', '2025-09-01', NULL),
       ...
       (14, 13, 'Васильева Екатерина Дмитриевна', '2003-08-11', 'vasilieva@example.com', '+79001000017', '2025-09-01',
        NULL),
       (15, 14, 'Николаев Роман Викторович', '2002-06-03', 'nikolaev@example.com', '+79001000018', '2025-09-01',
...
-- Tasks (15 задач)
-- ============================================================
INSERT INTO tasks (id, author_id, assignee_id, room_id, task_type, description, priority, status)
VALUES (1, 4, 2, 1, 'Ремонт', 'Сломан кран в ванной', 'high', 'assigned'),
       ...
       (15, 6, NULL, 9, 'Мебель', 'Нужна замена матраса — продавлен', 'medium', 'new') ON CONFLICT (id) DO NOTHING;
...
-- ============================================================
INSERT INTO task_history (id, task_id, previous_status, new_status, changed_by, changed_at, comment)
VALUES (1, 1, '', 'new', 4, '2025-10-01 09:00:00+03', 'Задача создана'),
       ...
       (15, 13, 'assigned', 'completed', 3, '2025-10-10 16:00:00+03',
        'Антивирус установлен') ON CONFLICT (id) DO NOTHING;
...
-- ============================================================
INSERT INTO task_comments (id, task_id, author_id, comment_text, created_at)
VALUES (1, 1, 4, 'Кран течёт уже второй день, вода на полу', '2025-10-01 09:05:00+03'),
       ...
       (15, 15, 6, 'Матрас совсем продавился по центру, спать невозможно',
        '2025-10-11 08:00:00+03') ON CONFLICT (id) DO NOTHING;
...
-- ============================================================
INSERT INTO user_activity_log (id, user_id, action, details, ip_address, user_agent, created_at)
VALUES (1, 1, 'login', '{"method": "password"}', '192.168.1.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',
        '2025-10-01 08:00:00+03'),
       (2, 1, 'user_registered', '{"target_user_id": 4, "email": "ivanov@heicrm.ru"}', '192.168.1.1',
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '2025-10-01 08:10:00+03'),
       (3, 4, 'login', '{"method": "password"}', '192.168.1.10', 'Mozilla/5.0 (Linux; Android 13)',
        '2025-10-01 08:30:00+03'),
       (4, 4, 'profile_updated', '{"fields": ["phone", "first_name"]}', '192.168.1.10',
        'Mozilla/5.0 (Linux; Android 13)', '2025-10-01 08:35:00+03'),
       (5, 2, 'login', '{"method": "password"}', '192.168.1.5', 'Mozilla/5.0 (Macintosh; Intel Mac OS X)',
        '2025-10-01 09:00:00+03'),
       (6, 5, 'login', '{"method": "password"}', '192.168.1.11', 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0)',
        '2025-10-02 08:00:00+03'),
       (7, 5, 'profile_updated', '{"fields": ["last_name"]}', '192.168.1.11',
        'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0)', '2025-10-02 08:10:00+03'),
       (8, 1, 'user_updated', '{"target_user_id": 6, "fields": ["role_id"]}', '192.168.1.1',
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', '2025-10-02 10:00:00+03'),
       (9, 3, 'login', '{"method": "password"}', '192.168.1.6', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',
        '2025-10-03 07:30:00+03'),
       (10, 6, 'login', '{"method": "password"}', '192.168.1.12', 'Mozilla/5.0 (Linux; Android 14)',
        '2025-10-03 08:00:00+03'),
       (11, 7, 'login', '{"method": "password"}', '192.168.1.13', 'Mozilla/5.0 (Macintosh; Intel Mac OS X)',
        '2025-10-03 09:00:00+03'),
       (12, 1, 'token_refresh', '{}', '192.168.1.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',
        '2025-10-03 12:00:00+03'),
       (13, 8, 'login', '{"method": "password"}', '192.168.1.14', 'Mozilla/5.0 (X11; Linux x86_64)',
        '2025-10-04 08:00:00+03'),
       (14, 1, 'user_deleted', '{"target_user_id": 99}', '192.168.1.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',
        '2025-10-05 16:00:00+03'),
       (15, 9, 'login', '{"method": "password"}', '192.168.1.15', 'Mozilla/5.0 (iPad; CPU OS 17_0)',
        '2025-10-06 07:00:00+03') ON CONFLICT (id) DO NOTHING;

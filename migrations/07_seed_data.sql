...
-- ============================================================
INSERT INTO residents (id, room_id, full_name, birth_date, passport_series, passport_number, email, phone, move_in_date, move_out_date) VALUES
    (1,  1,  'Иванов Дмитрий Сергеевич',     '2003-05-10', '4520', '100001', 'ivanov@heicrm.ru',     '+79001000004', '2025-09-01', NULL),
    (2,  2,  'Козлова Анна Петровна',          '2002-11-28', '4521', '100002', 'kozlova@heicrm.ru',    '+79001000005', '2025-09-01', NULL),
    (3,  2,  'Новиков Сергей Дмитриевич',      '2003-02-14', '4522', '100003', 'novikov@heicrm.ru',    '+79001000006', '2025-09-01', NULL),
    (4,  3,  'Морозова Елена Викторовна',      '2001-08-05', '4523', '100004', 'morozova@heicrm.ru',   '+79001000007', '2025-09-01', NULL),
    (5,  3,  'Волков Артём Андреевич',          '2002-12-30', '4524', '100005', 'volkov@heicrm.ru',     '+79001000008', '2025-09-01', NULL),
    (6,  4,  'Лебедева Ольга Николаевна',      '2003-04-17', '4525', '100006', 'lebedeva@heicrm.ru',   '+79001000009', '2025-09-01', NULL),
    (7,  4,  'Соколов Максим Олегович',        '2002-09-03', '4526', '100007', 'sokolov@heicrm.ru',    '+79001000010', '2025-09-01', NULL),
    (8,  6,  'Попова Наталья Ивановна',        '2001-06-21', '4527', '100008', 'popova@heicrm.ru',     '+79001000011', '2025-09-01', NULL),
    (9,  7,  'Кузнецов Андрей Владимирович',   '2003-01-09', '4528', '100009', 'kuznetsov@heicrm.ru',  '+79001000012', '2025-09-01', NULL),
    (10, 7,  'Фёдорова Татьяна Михайловна',    '2002-10-12', '4529', '100010', 'fedorova@heicrm.ru',   '+79001000013', '2025-09-01', NULL),
    (11, 9,  'Михайлов Владимир Алексеевич',   '2003-07-07', '4530', '100011', 'mikhailov@heicrm.ru',  '+79001000014', '2025-09-01', NULL),
    (12, 9,  'Егорова Ирина Сергеевна',        '2001-03-25', '4531', '100012', 'egorova@heicrm.ru',    '+79001000015', '2025-09-01', NULL),
    (13, 11, 'Смирнов Павел Олегович',         '2002-04-20', '4532', '100013', 'smirnov@example.com',  '+79001000016', '2025-09-01', NULL),
    (14, 13, 'Васильева Екатерина Дмитриевна', '2003-08-11', '4533', '100014', 'vasilieva@example.com', '+79001000017', '2025-09-01', NULL),
    (15, 14, 'Николаев Роман Викторович',      '2002-06-03', '4534', '100015', 'nikolaev@example.com',  '+79001000018', '2025-09-01', NULL)
ON CONFLICT (id) DO NOTHING;
